...
import dev.matthiesen.common.cobblemon_pokestops.client.renderer.item.WingedstopTrophyItemRenderer;
...
public class WingedstopTrophyItem extends StopItemTemplate {
    ...
    protected BlockEntityWithoutLevelRenderer getRenderer() {
        return new WingedstopTrophyItemRenderer();
    }
}
