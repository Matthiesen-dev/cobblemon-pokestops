...
public class CriterionTriggerRegistry {
    ...
    public static final Supplier<UsedHealingstopCriterion> USE_HEALINGSTOP = register("used_healingstop", UsedHealingstopCriterion::new);
    ...
    public static final Supplier<HealingstopScoreTracker> HEALINGSTOP_SCORE = register("healingstop_score", HealingstopScoreTracker::new);
