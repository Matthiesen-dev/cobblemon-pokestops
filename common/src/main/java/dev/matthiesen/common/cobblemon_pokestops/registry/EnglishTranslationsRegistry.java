...
public class EnglishTranslationsRegistry {
    ...
    static {
        ...
        TRANSLATIONS.put("config.jade.plugin_cobblemon_pokestops.cooldown", "Cooldown");
        TRANSLATIONS.put("config.jade.plugin_cobblemon_pokestops.cooldown_dummy", "Cooldown");
