...
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.block.stops.HealingstopRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.block.stops.PokeballstopRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.block.stops.PokestopRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.block.stops.WingedstopRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.block.trophies.HealingstopTrophyRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.block.trophies.PokeballstopTrophyRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.block.trophies.PokestopTrophyRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.block.trophies.WingedstopTrophyRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.item.stops.HealingstopItemRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.item.stops.PokeballstopItemRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.item.stops.PokestopItemRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.item.stops.WingedstopItemRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.item.trophies.HealingstopTrophyItemRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.item.trophies.PokeballstopTrophyItemRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.item.trophies.PokestopTrophyItemRenderer;
import dev.matthiesen.cobblemon_pokestops.common.client.renderer.item.trophies.WingedstopTrophyItemRenderer;
