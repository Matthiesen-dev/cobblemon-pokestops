...
- [ ] JER / EMI Loot Integration
  - Description: Integrate the Pokestop system with popular recipe viewing mods like JER (Just Enough Resources) or EMI (Enhanced Mod Integration) to allow players to see the loot tables for items that can be obtained from Pokestops.
  - Functionality: Players would be able to view the loot tables for items that can be obtained from Pokestops directly in JER or EMI, making it easier for them to plan their interactions with Pokestops and know what rewards they can expect.
...
- [ ] Additional Pokestop Types
  ...
  - Advancement Chains: Each new Pokestop type would have its own advancement chain and trophy for players to earn by using that specific type of Pokestop a certain number of times.